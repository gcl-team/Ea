...
namespace O2DESNet.UnitTests.Distributions
{
    ...
    internal class EmpiricalHelperTests
    {
        ...
        [Test]
        public void Sample_WithEmptyRatios_ThrowsArgumentException()
        {
        ...
        [Test]
        public void Sample_WithAllZeroRatios_ThrowsInvalidOperationException()
        {
            var ratios = new List<double> { 0.0, 0.0, 0.0 };
